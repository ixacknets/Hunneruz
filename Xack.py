...
def SSH_Brut():
	...
	try:
		...
		if password == "":
			...
			sys.exit(1)
		os.system('python3 ssh.py '+host+' '+user+' '+password)
	except:
...
def FTP_Brut():
	...
	if password_list == '':
		...
		sys.exit(1)
	os.system('python3 ftp.py '+host+' '+user+' '+password_list)
...
def mail():
	...
	if password == '':
		print(F+'Password list: password_list.txt'+E)
		password = 'password_list.txt'
